...
import com.spt.workshop.web.EmployeeController;
...
privileged aspect EmployeeController_Roo_Controller {
    ...
    public String EmployeeController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("employees", Employee.findEmployeeEntries(firstResult, sizeNo, sortFieldName, sortOrder));
    ...
    void EmployeeController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("employee_birthday_date_format", "dd/MM/yyyy");
    }
    ...
    void EmployeeController.populateEditForm(Model uiModel, Employee employee) {
        ...
        uiModel.addAttribute("emptypes", EmpType.findAllEmpTypes());
    }
